...
```{r dag_amly_a, fig.align="center", echo=FALSE, out.width='80%'}
...
```{r dag_almy_a, fig.align="center", echo=FALSE, out.width='80%'}
...
```{r algo_step, fig.align="center", echo=FALSE, out.width='60%'}
